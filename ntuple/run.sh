...
python flipskim.py -d nanov5_2017 --Samples "SingleElectron" --Samples "DoubleEG" --Samples "DYJetsToLL_M-50-LO_ext1" --Samples "DYJetsToLL_M-50_ext1" -b -t
python flipskim.py -d nanov5_2018 --Samples "EGamma" --Samples "DYJetsToLL_M-50-LO" --Samples "DYJetsToLL_M-50_ext2" -b -t
